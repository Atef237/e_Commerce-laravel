       ...
       <div class="main-menu-content">
              ...
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     ...
                     <ul class="menu-content">
                     <li class="active"><a class="menu-item" href="{{route('main_categories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                     </li>
...
{{--                     </a>--}}
{{--                     <ul class="menu-content">--}}
{{--                     <li class="active"><a class="menu-item" href="{{route('sub_categories')}}"--}}
{{--                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
{{--                     </li>--}}
{{--                     <li><a class="menu-item" href="{{route('sub_categories.create')}}" data-i18n="nav.dash.crypto">أضافة--}}
{{--                            قسم فرعي جديد </a>--}}
{{--                     </li>--}}
{{--                     </ul>--}}
{{--              </li>--}}
              ...
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     ...
                     <li><a class="menu-item" href="{{route('Brand.create')}}" data-i18n="nav.dash.crypto">أضافة
                            ماركة  </a>
                     </li>
                     </ul>
              </li>
              ...
              <li class="nav-item"><a href=""><i class="la la-male"></i>
                  ...
                  <li class="nav-item"><a href=""><i class="la la-male"></i>
                      ...
                      <ul class="menu-content">
                          <li class="active"><a class="menu-item" href="{{route('attribute')}}"
                                                data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                          </li>
                          <li><a class="menu-item" href="{{route('create.attribute')}}" data-i18n="nav.dash.crypto">أضافة
                                  خاصية </a>
                          </li>
                      </ul>
                  </li>
