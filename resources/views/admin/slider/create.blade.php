                    ...
                    <div class="row">
                            ...
                            @forelse($slides as $slide )
                                <figure class="col-lg-3 col-md-6 col-12" itemprop="associatedMedia" itemscope=""
                                    ...
                                    <a href="{{$slide -> photo}}" itemprop="contentUrl"
                                       data-size="480x360">
                                        <img class="img-thumbnail img-fluid"
                                             src="{{asset('assets/images/slide/'.$slide -> photo)}}"
{{--                                             src="{{asset('images/slide/'.$slide -> photo)}}"--}}
...
@section('script')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles = {
            ...
            ,
            url: "{{route('store.slide.image')}}", // Set the url
            success:
