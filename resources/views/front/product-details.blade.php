...
{{--                                                                @foreach($product->photos as $photo)--}}
                                                                ...
                                                                <img class="img-fluid image-cover"
                                                                     src="{{ asset('assets/images/products/'.$product->photos[0]->photo ?? 'image-not-available.png')}}"
                                                                     alt=""
...
{{--                                                                @endforeach--}}
    ...
    @include('front.includes.successfully')   <!-- we can use only one with dynamic text -->
    @include('front.includes.exists')
@stop
