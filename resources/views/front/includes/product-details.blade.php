<div id="" class="modal fade quickview in view-modal-product-details-{{$product -> id}}" tabindex="-1" role="dialog" style="display: hidden;">
            ...
            <div class="modal-body">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-7 col-sm-7">
                        ...
                        <div id="product-description-short" itemprop="description"><p> {!!  $product -> short_description !!}</p></div>
